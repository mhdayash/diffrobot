...
def generate_launch_description():
    ...
    world_path = os.path.join(get_package_share_directory(pkg_name), "world", "house7.world")
    ...
    rviz_config_file = os.path.join(get_package_share_directory(pkg_name), "rviz", "rviz_sim.rviz")
